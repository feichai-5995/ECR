...
class Visualizer:
    ...
    def _generate_camera_pan(self,
        ...
        # create a camera pan around the scen
    ...
    def _render_pc(r, pc, camera, camera_pose):
        ...
        """
        scene = pyrender.Scene(bg_color=(0, 0, 0), ambient_light=(1, 1, 1)) # ,enable_software_renderer=True
        scene.add(pc)
    ...
    def _render_trajectory(r, trajectory, camera, camera_pose, frustum_images):
        ...
        """
        scene = pyrender.Scene(bg_color=(0, 0, 0, 0), ambient_light=(1, 1, 1)) # ,enable_software_renderer=True
    ...
    def _draw_hist(self, image, hist_values, hist_colors, hist_x, hist_y, hist_w, hist_h, hist_max):
        ...
        @param hist_w: Width in pixels. Width in pixels.
    ...
    def _render_frame_from_buffers(self):
        ...
        r = pyrender.OffscreenRenderer(self.render_width, self.render_height,point_size=2.0) # ,flags=pyrender.RenderFlags.NONE
