...
ext_modules = [
    Extension(
        ...
        #             ],
        include_dirs=[
                    '/data1/experiment/cxb/opencv/opencv-4.6.0/include',
                    # '/data1/experiment/cxb/opencv/opencv-4.6.0/build',
                    '/data1/experiment/cxb/opencv/opencv_build/include/opencv4',
                    np.get_include()],
        library_dirs=[
                    '/data1/experiment/cxb/opencv/opencv-4.6.0/build/lib',
                    '/data1/experiment/cxb/opencv/opencv_build/lib',
                    ],
